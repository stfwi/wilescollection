...
import wile.wilescollection.libmc.blocks.StandardBlocks.IStandardBlock.RenderTypeHint;
...
public class VariantSlabBlock extends StandardBlocks.WaterLoggable implements StandardBlocks.IStandardBlock
{
  ...
  public void appendHoverText(ItemStack stack, @Nullable IBlockReader world, List<ITextComponent> tooltip, ITooltipFlag flag)
  {
    ...
    if(with_pickup) Auxiliaries.Tooltip.addInformation("wilescollection.tooltip.slabpickup", "wilescollection.tooltip.slabpickup", tooltip, flag, true);
  }
