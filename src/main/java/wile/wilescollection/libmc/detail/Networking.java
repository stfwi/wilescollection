...
public class Networking
{
  ...
  public static class PacketContainerSyncClientToServer
  {
    ...
    public static void sendToServer(Container uicontainer, CompoundNBT nbt)
    { if(nbt!=null) DEFAULT_CHANNEL.sendToServer(new PacketContainerSyncClientToServer(uicontainer.containerId, nbt)); }
  ...
  public static class PacketContainerSyncServerToClient
  {
    ...
    void sendToListeners(World world, C uicontainer, CompoundNBT nbt)
    {
      for(PlayerEntity player: world.players()) {
        if(player.containerMenu.containerId != uicontainer.containerId) continue;
        sendToPlayer(player, uicontainer.containerId, nbt);
      }
    }
