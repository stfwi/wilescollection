...
public class Auxiliaries
{
  ...
  { return BlockTags.getAllTags().getTag(new ResourceLocation(modid, mod_tag_path)); }
  ...
  public static final AxisAlignedBB[] getMappedAABB(AxisAlignedBB[] bbs, Function<AxisAlignedBB,AxisAlignedBB> mapper) {
    final AxisAlignedBB[] transformed = new AxisAlignedBB[bbs.length];
