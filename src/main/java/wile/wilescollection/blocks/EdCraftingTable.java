...
public class EdCraftingTable
{
  ...
  public static class CraftingTableTileEntity extends TileEntity implements INameable, INamedContainerProvider, Networking.IPacketTileNotifyReceiver
  {
    ...
    { return new CraftingTableContainer(id, inventory, inventory_, IWorldPosCallable.create(level, worldPosition)); }
  ...
  public static class CraftingTableGui extends ContainerGui<CraftingTableContainer>
  {
    ...
    public CraftingTableGui(CraftingTableContainer uicontainer, PlayerInventory playerInventory, ITextComponent title)
    {
    ...
    protected void renderBg(MatrixStack mx, float partialTicks, int mouseX, int mouseY)
    {
      ...
      if(with_assist) {
        ...
        {
          int i = 0;
          for(Tuple<Integer, Integer> e : ((CraftingTableContainer)getMenu()).CRAFTING_SLOT_COORDINATES) {
  ...
  {
    private final CraftingTableContainer uicontainer;
    private final PlayerEntity player;
    private final CraftingInventory craftMatrix;
    private int amountCrafted;

    public CraftingOutputSlot(CraftingTableContainer uicontainer, PlayerEntity player, CraftingInventory craftingInventory, IInventory resultInventory, int slotIndex, int xPosition, int yPosition)
    {
  ...
  public static class CraftingTableGrid extends CraftingInventory
  {
    ...
    public CraftingTableGrid(Container uicontainer, IInventory block_inventory)
    { super(uicontainer, 3, 3); this.uicontainer = uicontainer; inventory = block_inventory; }
