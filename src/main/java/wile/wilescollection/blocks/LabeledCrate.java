...
import wile.wilescollection.libmc.detail.Inventories.MappedItemHandler;
...
public class LabeledCrate
{
  ...
  public static void on_config(boolean without_gui_mouse_handling)
  {
    ...
    unstorable_containers.add(ModContent.CRATE.asItem());
  ...
  public static class LabeledCrateBlock extends StandardBlocks.Horizontal implements StandardBlocks.IStandardBlock
  {
  ...
  public static class LabeledCrateGui extends ContainerGui<LabeledCrateContainer>
  {
    ...
    public LabeledCrateGui(LabeledCrateContainer uicontainer, PlayerInventory player_inventory, ITextComponent title)
    {
    ...
    protected void renderBg(MatrixStack mx, float partialTicks, int mouseX, int mouseY)
    {
      ...
      getMinecraft().getTextureManager().bind(new ResourceLocation(ModWilesCollection.MODID, "textures/gui/crate_gui.png"));
